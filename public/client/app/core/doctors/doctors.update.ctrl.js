(function () {
    ...
    DoctorsUpdateCtrl.$inject = ['$rootScope', 'FileUploader', 'Doctor', '$state','Language', 'API_ENDPOINT', 'NotificationsService'];
    function DoctorsUpdateCtrl($rootScope, FileUploader, Doctor, $state, Language, API_ENDPOINT, NotificationsService) {
        ...
        function getDoctor(){
            ...
            return  Doctor.get($rootScope.$stateParams.id)
                    .then(function(response) {
                        ...
                        uploader.url = 'api/doctors/' + vm.doctor.id;
